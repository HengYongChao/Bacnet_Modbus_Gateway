 ...
 * \ingroup QueueManagement
 */
signed portCHAR cQueueReceive( xQueueHandle xQueue, void *pcBuffer, portTickType xTicksToWait ) reentrant;
 ...
 * <HR>
 */
unsigned portCHAR ucQueueMessagesWaiting( xQueueHandle xQueue ) reentrant;
