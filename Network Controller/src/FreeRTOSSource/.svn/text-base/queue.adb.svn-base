M:______Source_queue
F:G$xQueueCreate$0$0({2}DF,DG,STQueueDefinition:S),Z,0,4,0,0,0
S:LxQueueCreate$ucItemSize$1$1({1}SC:U),B,1,-3
S:LxQueueCreate$ucQueueLength$1$1({1}SC:U),R,0,0,[r2]
S:LxQueueCreate$pxNewQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r3,r4,r5]
S:LxQueueCreate$usQueueSizeInBytes$1$1({2}SI:U),R,0,0,[r2,r3]
S:LxQueueCreate$sloc0$1$0({3}DG,DG,SC:S),B,1,5
S:LxQueueCreate$sloc1$1$0({2}SI:S),B,1,8
F:G$cQueueSend$0$0({2}DF,SC:S),Z,0,3,0,0,0
S:LcQueueSend$pvItemToQueue$1$1({3}DG,SV:S),B,1,-5
S:LcQueueSend$xTicksToWait$1$1({2}SI:U),B,1,-7
S:LcQueueSend$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
S:LcQueueSend$cReturn$1$1({1}SC:S),R,0,0,[r2]
S:LcQueueSend$sloc0$1$0({1}SC:U),B,1,4
S:LcQueueSend$sloc1$1$0({3}DG,SC:U),B,1,5
S:LcQueueSend$sloc2$1$0({3}DG,DG,SC:S),B,1,8
S:LcQueueSend$sloc3$1$0({2}SI:U),B,1,11
F:G$cQueueSendFromISR$0$0({2}DF,SC:S),Z,0,3,0,0,0
S:LcQueueSendFromISR$pvItemToQueue$1$1({3}DG,SV:S),B,1,-5
S:LcQueueSendFromISR$cTaskPreviouslyWoken$1$1({1}SC:S),B,1,-6
S:LcQueueSendFromISR$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
S:LcQueueSendFromISR$sloc0$1$0({1}SC:U),B,1,4
S:LcQueueSendFromISR$sloc1$1$0({3}DG,SC:U),B,1,5
S:LcQueueSendFromISR$sloc2$1$0({3}DG,DG,SC:S),B,1,8
S:LcQueueSendFromISR$sloc3$1$0({2}SI:U),B,1,11
F:G$cQueueReceive$0$0({2}DF,SC:S),Z,0,3,0,0,0
S:LcQueueReceive$pcBuffer$1$1({3}DG,SV:S),B,1,-5
S:LcQueueReceive$xTicksToWait$1$1({2}SI:U),B,1,-7
S:LcQueueReceive$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
S:LcQueueReceive$cReturn$1$1({1}SC:S),R,0,0,[r2]
S:LcQueueReceive$sloc0$1$0({3}DG,DG,SC:S),B,1,4
S:LcQueueReceive$sloc1$1$0({3}DG,SC:S),B,1,7
S:LcQueueReceive$sloc2$1$0({1}SC:U),B,1,10
S:LcQueueReceive$sloc3$1$0({1}SC:U),B,1,11
F:G$cQueueReceiveFromISR$0$0({2}DF,SC:S),Z,0,3,0,0,0
S:LcQueueReceiveFromISR$pcBuffer$1$1({3}DG,SV:S),B,1,-5
S:LcQueueReceiveFromISR$pcTaskWoken$1$1({3}DG,SC:S),B,1,-8
S:LcQueueReceiveFromISR$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
S:LcQueueReceiveFromISR$cReturn$1$1({1}SC:S),R,0,0,[r2]
S:LcQueueReceiveFromISR$sloc0$1$0({1}SC:U),B,1,4
S:LcQueueReceiveFromISR$sloc1$1$0({3}DG,DG,SC:S),B,1,5
S:LcQueueReceiveFromISR$sloc2$1$0({1}SC:U),B,1,8
S:LcQueueReceiveFromISR$sloc3$1$0({3}DG,STxLIST:S),B,1,9
F:G$ucQueueMessagesWaiting$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:LucQueueMessagesWaiting$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
S:LucQueueMessagesWaiting$ucReturn$1$1({1}SC:U),R,0,0,[r2]
F:G$vQueueDelete$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:LvQueueDelete$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
F:F______Source_queue$prvUnlockQueue$0$0({2}DF,SC:S),Z,0,4,0,0,0
S:LprvUnlockQueue$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
S:LprvUnlockQueue$cYieldRequired$1$1({1}SC:S),R,0,0,[r5]
F:F______Source_queue$prvIsQueueEmpty$0$0({2}DF,SC:S),Z,0,0,0,0,0
S:LprvIsQueueEmpty$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
S:LprvIsQueueEmpty$cReturn$1$1({1}SC:S),R,0,0,[r2]
F:F______Source_queue$prvIsQueueFull$0$0({2}DF,SC:S),Z,0,0,0,0,0
S:LprvIsQueueFull$pxQueue$1$1({3}DG,STQueueDefinition:S),R,0,0,[r2,r3,r4]
S:LprvIsQueueFull$cReturn$1$1({1}SC:S),R,0,0,[r5]
T:F______Source_queue$QueueDefinition[({0}S:S$pcHead$0$0({3}DG,SC:S),Z,0,0)({3}S:S$pcTail$0$0({3}DG,SC:S),Z,0,0)({6}S:S$pcWriteTo$0$0({3}DG,SC:S),Z,0,0)({9}S:S$pcReadFrom$0$0({3}DG,SC:S),Z,0,0)({12}S:S$xTasksWaitingToSend$0$0({22}STxLIST:S),Z,0,0)({34}S:S$xTasksWaitingToReceive$0$0({22}STxLIST:S),Z,0,0)({56}S:S$ucMessagesWaiting$0$0({1}SC:U),Z,0,0)({57}S:S$ucLength$0$0({1}SC:U),Z,0,0)({58}S:S$ucItemSize$0$0({1}SC:U),Z,0,0)({59}S:S$cRxLock$0$0({1}SC:S),Z,0,0)({60}S:S$cTxLock$0$0({1}SC:S),Z,0,0)]
T:F______Source_queue$xLIST_ITEM[({0}S:S$xItemValue$0$0({2}SI:U),Z,0,0)({2}S:S$pxNext$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxPrevious$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({8}S:S$pvOwner$0$0({3}DG,SV:S),Z,0,0)({11}S:S$pvContainer$0$0({3}DG,SV:S),Z,0,0)]
T:F______Source_queue$xLIST[({0}S:S$usNumberOfItems$0$0({2}SI:U),Z,0,0)({2}S:S$pxHead$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxIndex$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({8}S:S$xListEnd$0$0({14}STxLIST_ITEM:S),Z,0,0)]
T:F______Source_queue$MAH[({0}S:S$next$0$0({2}DX,STMAH:S),Z,0,0)({2}S:S$len$0$0({2}SI:U),Z,0,0)({4}S:S$mem$0$0({0}DA0,SC:U),Z,0,0)]
