M:______Source_portable_SDCC_cygnal_port
...
F:F______Source_portable_SDCC_cygnal_port$prvSetupTimerInterrupt$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
T:F______Source_portable_SDCC_cygnal_port$xLIST_ITEM[({0}S:S$xItemValue$0$0({2}SI:U),Z,0,0)({2}S:S$pxNext$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxPrevious$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({8}S:S$pvOwner$0$0({3}DG,SV:S),Z,0,0)({11}S:S$pvContainer$0$0({3}DG,SV:S),Z,0,0)]
T:F______Source_portable_SDCC_cygnal_port$xLIST[({0}S:S$usNumberOfItems$0$0({2}SI:U),Z,0,0)({2}S:S$pxHead$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({5}S:S$pxIndex$0$0({3}DG,STxLIST_ITEM:S),Z,0,0)({8}S:S$xListEnd$0$0({14}STxLIST_ITEM:S),Z,0,0)]
S:F______Source_portable_SDCC_cygnal_port$ucStackBytes$0$0({1}SC:U),E,0,0
S:F______Source_portable_SDCC_cygnal_port$pxXRAMStack$0$0({2}DX,SC:U),E,0,0
S:F______Source_portable_SDCC_cygnal_port$pxRAMStack$0$0({1}DD,SC:U),E,0,0
